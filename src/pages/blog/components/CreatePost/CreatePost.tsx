    ...
    <form onSubmit={handleSubmit} onReset={handleCancelEditingPost}>
      ...
      <div className='mb-6'>
        ...
        <input
          ...
          onChange={(event) => setFormData((prevState) => ({ ...prevState, featuredImage: event.target.value }))}
        />
      </div>
      <div className='mb-6'>
        <div>
      ...
      <div className='mb-6'>
        ...
        <input
          ...
          onChange={(event) => setFormData((prevState) => ({ ...prevState, publishDate: event.target.value }))}
        />
      </div>
      <div className='mb-6 flex items-center'>
        <input
          ...
          onChange={(event) => setFormData((prevState) => ({ ...prevState, published: event.target.checked }))}
